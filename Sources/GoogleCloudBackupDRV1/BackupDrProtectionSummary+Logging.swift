...
extension Clients {
  final class BackupDrProtectionSummaryLogging: BackupDrProtectionSummaryStub {
    let inner: any BackupDrProtectionSummaryStub
    let logger: Logger

    public init(_ inner: any BackupDrProtectionSummaryStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = "google-cloud-backupdr-v1"
      logger[metadataKey: "gcp.client.service"] = "backupdr"
      logger[metadataKey: "gcp.experimental.swift.client"] = "BackupDrProtectionSummary"
      self.inner = inner
      self.logger = logger
    }
    ...
    public func listResourceBackupConfigs(
      ...
      try await self._intercept(
        request: request,
        options: options,
        name: "listResourceBackupConfigs",
        action: {
          (r: ListResourceBackupConfigsRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudBackupDRV1.ListResourceBackupConfigsResponse
          in
          return try await self.inner.listResourceBackupConfigs(request: r, options: o)
        })
    }
