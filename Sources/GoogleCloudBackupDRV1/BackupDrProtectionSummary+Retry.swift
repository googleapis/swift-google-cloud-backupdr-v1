...
extension Clients {
  final class BackupDrProtectionSummaryRetry: BackupDrProtectionSummaryStub {
    let inner: any BackupDrProtectionSummaryStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any BackupDrProtectionSummaryStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
